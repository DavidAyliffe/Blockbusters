...
| 03 | ⚔️ Chunin | Complex Filtering | `HAVING`, date functions, `NOW()`, compound `WHERE` clauses |
| 04 | 🛡️ ANBU | Advanced Joins | Self-joins, joining the same table multiple times |
...
Each level is estimated at ~2 class sessions, totalling approximately 20 hours of coursework. ⏱️
...
- 🏷️ **category** - Film genre classification
...
- 🖥️ A MySQL client (MySQL Workbench, CLI, or similar)
...
4. **Check your work** against the corresponding answer file when finished. ✔️
...
- 👁️ Database views and stored procedures
